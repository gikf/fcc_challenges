...
class UnitTests(unittest.TestCase):
  ...
  def test_hash_salted_1(self):
    ...
    expected = "superman"
    self.assertEqual(actual, expected, 'Expected function to return "superman" from hash "53d8b3dc9d39f0184144674e310185e41a87ffd5".')
  ...
  def test_hash_salted_2(self):
    ...
    expected = "q1w2e3r4t5"
    self.assertEqual(actual, expected, 'Expected function to return "q1w2e3r4t5" from hash "da5a4e8cf89539e66097acd2f8af128acae2f8ae".')
  ...
  def test_hash_salted_3(self):
    ...
    expected = "bubbles1"
    self.assertEqual(actual, expected, 'Expected function to return "bubbles1" from hash "ea3f62d498e3b98557f9f9cd0d905028b3b019e1".')

  def test_hash_salted_4(self):
    actual = password_cracker.crack_sha1_hash("05bbf26a28148f531cf57872df546961d1ed0861", use_salts=True)
    expected = "01071988"
    self.assertEqual(actual, expected, 'Expected function to return "01071988" from hash "05bbf26a28148f531cf57872df546961d1ed0861".')
